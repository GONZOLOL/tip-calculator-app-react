        ...
        <div className='block'>
          ...
          <div className='container'>
            ...
            <div className='row'>
              ...
              <div className='col'>
                <span className='headers'>Bill</span> <br/>
                ...
                <div>
                  <span className='headers'>Select Tip %</span> <br/>
                  <div className='container text-center'>
                    <div className='row row-cols-3 justify-content-between'>
                      ...
                      <label className='boton btn' htmlFor="btn-1">5%</label>
                      <input type="radio" id="btn-2" value="10" name="tip" autoComplete="off" className='btn-check' onChange={handleClick} />
                      <label className='boton btn' htmlFor="btn-2">10%</label>
                      <input type="radio" id="btn-3" value="15" name="tip" autoComplete="off" className='btn-check' onChange={handleClick} />
                      <label className='boton btn' htmlFor="btn-3">15%</label>
                      <input type="radio" id="btn-4" value="25" name="tip" autoComplete="off" className='btn-check' onChange={handleClick} />
                      <label className='boton btn' htmlFor="btn-4">25%</label>
                      <input type="radio" id="btn-5" value="50" name="tip" autoComplete="off" className='btn-check' onChange={handleClick} />
                      <label className='boton btn' htmlFor="btn-5">50%</label>
                      <input type="number" placeholder="Custom" id="custom" min="1" max="100" pattern="^[0-9]+" className='guess custom' onChange={handleCustomTip}/>
                    </div>
                  </div>
                </div>
                <div>
                  <div className='headers'>Number of People</div>
                  <div className='input-group'>
                    <div className='input-group-text dollar'><AttachMoneyIcon/></div>
              ...
              <div className='col inner-block'>
                <div className='container blue-block'>
                  <div className='row'>
                    <div className='col'>
                      <p className='headers'>Tip Amount</p>
                      <p className='low-headers'>/ person</p> 
                    </div>
                    <div className='col tip-amount' id="tip-amount">$0.00</div>
                  </div>
                  <div className='row'>
                    <div className='col'>
                    ...
                    <div className='col total' id="total">$0.00</div>
                  </div>
                  <div className='row'>
